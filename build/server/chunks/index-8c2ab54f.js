...
const VERSION = '4.14.2'; // x-release-please-version
...
let getMultipartRequestOptions$1 = undefined;
...
class Blob {
    constructor(blobParts = [], options = {}) {
        ...
        for (const raw of blobParts) {
            ...
            __classPrivateFieldSet$3(this, _Blob_size, __classPrivateFieldGet$4(this, _Blob_size, "f") + (ArrayBuffer.isView(part) ? part.byteLength : part.size), "f");
            __classPrivateFieldGet$4(this, _Blob_parts, "f").push(part);
        }
        const type = options.type === undefined ? "" : String(options.type);
        __classPrivateFieldSet$3(this, _Blob_type, /^[\x20-\x7E]*$/.test(type) ? type : "", "f");
    }
    ...
    get type() {
        return __classPrivateFieldGet$4(this, _Blob_type, "f");
    }
    get size() {
        return __classPrivateFieldGet$4(this, _Blob_size, "f");
    }
    slice(start, end, contentType) {
        return new Blob(sliceBlob(__classPrivateFieldGet$4(this, _Blob_parts, "f"), this.size, start, end), {
            type: contentType
        });
    }
    async text() {
        ...
        let result = "";
        for await (const chunk of consumeBlobParts(__classPrivateFieldGet$4(this, _Blob_parts, "f"))) {
    ...
    stream() {
        const iterator = consumeBlobParts(__classPrivateFieldGet$4(this, _Blob_parts, "f"), true);
...
class File extends Blob {
    constructor(fileBits, name, options = {}) {
        ...
        __classPrivateFieldSet$2(this, _File_name, String(name), "f");
        const lastModified = options.lastModified === undefined
            ? Date.now()
            : Number(options.lastModified);
        if (!Number.isNaN(lastModified)) {
            __classPrivateFieldSet$2(this, _File_lastModified, lastModified, "f");
        }
    }
    ...
    get name() {
        return __classPrivateFieldGet$3(this, _File_name, "f");
    }
    get lastModified() {
        return __classPrivateFieldGet$3(this, _File_lastModified, "f");
    }
...
class FormData {
    ...
    append(name, value, fileName) {
        __classPrivateFieldGet$2(this, _FormData_instances, "m", _FormData_setEntry).call(this, {
            name,
            fileName,
            append: true,
            rawValue: value,
    ...
    get(name) {
        const field = __classPrivateFieldGet$2(this, _FormData_entries, "f").get(String(name));
        if (!field) {
            return null;
        }
        return field[0];
    ...
    has(name) {
        return __classPrivateFieldGet$2(this, _FormData_entries, "f").has(String(name));
    }
    delete(name) {
        __classPrivateFieldGet$2(this, _FormData_entries, "f").delete(String(name));
    }
    *keys() {
        for (const key of __classPrivateFieldGet$2(this, _FormData_entries, "f").keys()) {
            yield key;
        }
    }
    *entries() {
    ...
    *values() {
    ...
    [(_FormData_setEntry = function _FormData_setEntry({ name, rawValue, append, fileName, argsLength }) {
        ...
        const values = __classPrivateFieldGet$2(this, _FormData_entries, "f").get(name);
        if (!values) {
            return void __classPrivateFieldGet$2(this, _FormData_entries, "f").set(name, [value]);
        }
        if (!append) {
            return void __classPrivateFieldGet$2(this, _FormData_entries, "f").set(name, [value]);
        }
...
function requireAgentkeepalive () {
	...
	agentkeepalive.exports = requireAgent();
...
var KeepAliveAgent = /*@__PURE__*/getDefaultExportFromCjs(agentkeepaliveExports);
...
class FormDataEncoder {
    constructor(form, boundaryOrOptions, options) {
        ...
        __classPrivateFieldSet$1(this, _FormDataEncoder_form, form, "f");
        __classPrivateFieldSet$1(this, _FormDataEncoder_options, { ...defaultOptions, ...options }, "f");
        __classPrivateFieldSet$1(this, _FormDataEncoder_CRLF_BYTES, __classPrivateFieldGet$1(this, _FormDataEncoder_encoder, "f").encode(__classPrivateFieldGet$1(this, _FormDataEncoder_CRLF, "f")), "f");
        __classPrivateFieldSet$1(this, _FormDataEncoder_CRLF_BYTES_LENGTH, __classPrivateFieldGet$1(this, _FormDataEncoder_CRLF_BYTES, "f").byteLength, "f");
        this.boundary = `form-data-boundary-${boundary}`;
        this.contentType = `multipart/form-data; boundary=${this.boundary}`;
        __classPrivateFieldSet$1(this, _FormDataEncoder_footer, __classPrivateFieldGet$1(this, _FormDataEncoder_encoder, "f").encode(`${__classPrivateFieldGet$1(this, _FormDataEncoder_DASHES, "f")}${this.boundary}${__classPrivateFieldGet$1(this, _FormDataEncoder_DASHES, "f")}${__classPrivateFieldGet$1(this, _FormDataEncoder_CRLF, "f").repeat(2)}`), "f");
    ...
    getContentLength() {
        let length = 0;
        for (const [name, raw] of __classPrivateFieldGet$1(this, _FormDataEncoder_form, "f")) {
            const value = isFileLike$1(raw) ? raw : __classPrivateFieldGet$1(this, _FormDataEncoder_encoder, "f").encode(normalizeValue(raw));
            length += __classPrivateFieldGet$1(this, _FormDataEncoder_instances, "m", _FormDataEncoder_getFieldHeader).call(this, name, value).byteLength;
            length += isFileLike$1(value) ? value.size : value.byteLength;
            length += __classPrivateFieldGet$1(this, _FormDataEncoder_CRLF_BYTES_LENGTH, "f");
        }
        return length + __classPrivateFieldGet$1(this, _FormDataEncoder_footer, "f").byteLength;
    }
    *values() {
        for (const [name, raw] of __classPrivateFieldGet$1(this, _FormDataEncoder_form, "f").entries()) {
            const value = isFileLike$1(raw) ? raw : __classPrivateFieldGet$1(this, _FormDataEncoder_encoder, "f").encode(normalizeValue(raw));
            yield __classPrivateFieldGet$1(this, _FormDataEncoder_instances, "m", _FormDataEncoder_getFieldHeader).call(this, name, value);
            yield value;
            yield __classPrivateFieldGet$1(this, _FormDataEncoder_CRLF_BYTES, "f");
        }
        yield __classPrivateFieldGet$1(this, _FormDataEncoder_footer, "f");
    }
    async *encode() {
        for (const part of this.values()) {
            if (isFileLike$1(part)) {
                yield* part.stream();
            }
            else {
                yield part;
    ...
    [(_FormDataEncoder_CRLF = new WeakMap(), _FormDataEncoder_CRLF_BYTES = new WeakMap(), _FormDataEncoder_CRLF_BYTES_LENGTH = new WeakMap(), _FormDataEncoder_DASHES = new WeakMap(), _FormDataEncoder_encoder = new WeakMap(), _FormDataEncoder_footer = new WeakMap(), _FormDataEncoder_form = new WeakMap(), _FormDataEncoder_options = new WeakMap(), _FormDataEncoder_instances = new WeakSet(), _FormDataEncoder_getFieldHeader = function _FormDataEncoder_getFieldHeader(name, value) {
        let header = "";
        header += `${__classPrivateFieldGet$1(this, _FormDataEncoder_DASHES, "f")}${this.boundary}${__classPrivateFieldGet$1(this, _FormDataEncoder_CRLF, "f")}`;
        header += `Content-Disposition: form-data; name="${escapeName(name)}"`;
        if (isFileLike$1(value)) {
            header += `; filename="${escapeName(value.name)}"${__classPrivateFieldGet$1(this, _FormDataEncoder_CRLF, "f")}`;
            header += `Content-Type: ${value.type || "application/octet-stream"}`;
        }
        if (__classPrivateFieldGet$1(this, _FormDataEncoder_options, "f").enableAdditionalHeaders === true) {
            header += `${__classPrivateFieldGet$1(this, _FormDataEncoder_CRLF, "f")}Content-Length: ${isFileLike$1(value) ? value.size : value.byteLength}`;
        }
        return __classPrivateFieldGet$1(this, _FormDataEncoder_encoder, "f").encode(`${header}${__classPrivateFieldGet$1(this, _FormDataEncoder_CRLF, "f").repeat(2)}`);
    }, Symbol.iterator)]() {
        return this.values();
    }
...
var ponyfill_es2018Exports = requirePonyfill_es2018();

let fileFromPathWarned = false;
async function fileFromPath(path, ...args) {
    // this import fails in environments that don't handle export maps correctly, like old versions of Jest
    const { fileFromPath: _fileFromPath } = await import('./fileFromPath-6dfa88d8.js');
...
function getRuntime() {
    ...
    return {
        ...
        Blob: Blob,
        File: File,
        ReadableStream: ponyfill_es2018Exports.ReadableStream,
...
class Chat extends APIResource {
    constructor() {
        super(...arguments);
        this.completions = new Completions$1(this.client);
    }
}
(function (Chat) {
...
(function (FineTunes) {
    FineTunes.FineTunesPage = FineTunesPage;
})(FineTunes || (FineTunes = {}));
...
export { File as F, index as a, getDefaultExportFromCjs as g, isFile as i };
//# sourceMappingURL=index-8c2ab54f.js.map
